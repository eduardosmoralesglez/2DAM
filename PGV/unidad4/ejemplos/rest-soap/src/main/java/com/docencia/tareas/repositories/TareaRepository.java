...
public class TareaRepository implements ITareaRepository{
    ...
    public TareaRepository() {
        Tarea tarea1 = new Tarea(1, "Estudiante Typescript", "Repasar tipos y funciones", false);
        Tarea tarea2 = new Tarea(2, "Hacer practica 1", "Proyecto tareas en memoria", true);
